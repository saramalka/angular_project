...
//         return this._http.get<Product[]>("http://localhost:3000/api/products")
//     }

//     saveProductToServer(product: Product): Observable<boolean> {
//         return this._http.post<boolean>("http://localhost:3000/api/products", product)
//     }

//     deleteProductFromServer(product: Product) {
//         return this._http.delete("http://localhost:3000/api/products/" + product.id)
//     }
//     editProductFromServer(product: Product) {
//         return this._http.put("http://localhost:3000/api/products/" + product.id, product)
//     }

//     getOneFromServer(id: number): Observable<Product> {
//         return this._http.get<Product>("http://localhost:3000/api/products=" + id)
//     }
//     getProductsData() {
//         return [
//             createProduct({
